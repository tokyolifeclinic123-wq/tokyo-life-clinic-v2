...
const ROWS = [
  ...
  { label: '配送時期',           value: '着日指定のない場合、14:00までの決済完了は、原則当日に発送いたします（※1）製品到着は、運送会社の状況によりますが、ご購入日から通常1日〜5日程でお届けいたします（※2）※1) 上記発送予定日が土日祝日・弊院休業日の場合は、【翌営業日】に発送いたします。※2) 配送日指定いただいている場合を除きます。天候や交通状況により遅れが発生する場合がございます。あらかじめご了承くださいますようお願いいたします。' },
